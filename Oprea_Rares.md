...
Hier werden alle Standard Operatoren und Klammern berücksichtigt, sowie die Priorität der Operatoren, sowie einige außergewöhnliche Operatoren, wie ^ oder >> oder <<>>.
...
Die Funktion zur Erstellung eines Termbaums aus einem arithmetischen Ausdruck ist implementiert. Der Termbaum wird rekursiv aufgebaut, wobei jeder Knoten einen Operator oder Operand darstellt.
Die Knoten werden entsprechend ihrer Priorität und Position im Ausdruck angeordnet, um die korrekte Reihenfolge der Operationen darzustellen.
Der Termbaum wird dann auch in ein Bild dargestellt, um die Struktur visuell zu speichern.
